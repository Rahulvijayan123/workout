...
CREATE INDEX idx_rec_events_user_exercise ON recommendation_events(user_id, exercise_id);
CREATE INDEX idx_rec_events_session ON recommendation_events(session_id);
CREATE INDEX idx_rec_events_policy ON recommendation_events(policy_version, policy_type);
CREATE INDEX idx_rec_events_exploration ON recommendation_events(is_exploration) WHERE is_exploration = TRUE;
CREATE INDEX idx_rec_events_time ON recommendation_events(generated_at);
...
CREATE INDEX idx_planned_sets_exercise ON planned_sets(session_exercise_id);
...
CREATE INDEX idx_pain_events_user ON pain_events(user_id);
CREATE INDEX idx_pain_events_session ON pain_events(session_id);
CREATE INDEX idx_pain_events_exercise ON pain_events(session_exercise_id);
CREATE INDEX idx_pain_events_severity ON pain_events(severity) WHERE severity >= 5;
...
CREATE INDEX idx_sensitive_context_user_date ON user_sensitive_context(user_id, date);
...
CREATE INDEX idx_exercise_variants_base ON exercise_variants(base_exercise_id);
